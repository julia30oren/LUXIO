...
router.post("/:lang/save", async(req, res, next) => {
    ...
    const { burcode_id, prod_class, name, prod_collection, img_link_1, amount_1, price_1,
        color, tint, transparency, label,
        amount_2, price_2,amount_3, price_3,amount_4, price_4,amount_5, price_5,amount_6, price_6,
        img_link_2, img_link_3, img_link_4, img_link_5, img_link_6, 
        coment_eng, coment_iv, coment_rus } = req.body;
